                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('certifications') is-invalid @enderror"
                            ...
                            value="{{ old('certifications', is_array($teacher->certifications) ? implode(', ', $teacher->certifications) : $teacher->certifications) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('publications') is-invalid @enderror"
                            id="publications" name="publications"
                            value="{{ old('publications', is_array($teacher->publications) ? implode(', ', $teacher->publications) : $teacher->publications) }}">
                        @error('publications')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-xl-9 mx-auto">
                            ...
                            <div class="card">
                                <div class="card-body" style="position: relative">
                                    <label for="fancy-file-upload" id="image-label">Click to add Photo</label>
                                    <input id="fancy-file-upload" type="file" name="profile_photo"
